...
//   /* because of the drag and drop component, we will not show/run on server-side rendering */
...
//                     ref={provided.innerRef}
//                     className="flex items-center bg-[#ece0f1] rounded-lg text-sm font-medium p-3"
//                   >
//                     <div {...provided.dragHandleProps}>
//                       <Grip className="h-4 w-4 cursor-pointer mr-4 hover:text-[#b271c9]" />
//                     </div>
//                     {section.title}
//                     <div className="ml-auto">
//                       <Pencil
//                         className="h-4 w-4 cursor-pointer hover:text-[#b271c9]"
